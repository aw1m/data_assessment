        ...
        if records == []:
            ...
            if db_updated_at is None and updated_at is not None:
                ...
                try:
                    ...
                    print(e)
                    print(user_uuid ,activity_uuid ,questionnaire_uuid ,context_uuid ,question_uuid ,single_answer_choice_uuid ,attempt_number ,confidence ,type ,submitted_at  ,created_at ,updated_at ,deleted_at)
                    print(records)
                    not_processed.append(questionnaire_attempt)
            else:
                not_processed.append(questionnaire_attempt)
